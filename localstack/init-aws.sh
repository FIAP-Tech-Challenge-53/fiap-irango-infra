...
awslocal sqs create-queue --queue-name fiap-irango-cook_order-created_dev
...
awslocal sns subscribe \
  ...
  --protocol sqs \
  --topic-arn arn:aws:sns:us-east-1:000000000000:fiap-irango-order_order-created_dev \
  --notification-endpoint arn:aws:sqs:us-east-1:000000000000:fiap-irango-cook_order-created_dev
